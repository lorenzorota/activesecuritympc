from .additive import get_additive_shares
...
def protocol_2(
    final_shares: Public[Array[field, 3]],
    _one: Public[field],
) -> field:
    ...
    Args:
        final_shares (Public[Array[field, 3]]): The received combinations (including the locally produced one).
        _one (Public[field]): The multiplicative identity.
