...
def get_additive_shares(
    ...
    Args:
        ...
        randomness (Private[Array[field, 44]]): The randomness for creating secret shares.
    ...
    shares: Array[field, 45] = [field(0) for _ in range(N)]
...
# This can be verifiably computed
def reconstruct_secret(shares: Private[Array[field, 45]], _one: Public[field]) -> field:
    """Regenerate secret from additive shares.

    Args:
        shares (Private[Array[field, 45]]): The secret shares.
