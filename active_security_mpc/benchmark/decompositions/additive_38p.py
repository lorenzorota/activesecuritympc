...
def get_additive_shares(
    ...
    Args:
        ...
        randomness (Private[Array[field, 37]]): The randomness for creating secret shares.
    ...
    shares: Array[field, 38] = [field(0) for _ in range(N)]
...
# This can be verifiably computed
def reconstruct_secret(shares: Private[Array[field, 38]], _one: Public[field]) -> field:
    """Regenerate secret from additive shares.

    Args:
        shares (Private[Array[field, 38]]): The secret shares.
