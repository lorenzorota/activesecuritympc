from .additive_32p import get_additive_shares
from .additive_32p import reconstruct_secret
...
def protocol_1(
    ...
    Args:
        ...
        rand (Private[Array[field, 31]]): Randomness needed for creating secret shares.
...
def protocol_2(
    mixed_shares: Private[Array[field, 32]],
    _one: Public[field],
) -> field:
    ...
    Args:
        mixed_shares (Private[Array[field, 32]]): The received secret shares (including the initial secret).
        _one (Public[field]): The multiplicative identity.
...
def protocol_3(
    final_shares: Private[Array[field, 32]],
    _one: Public[field],
) -> field:
    ...
    Args:
        final_shares (Private[Array[field, 32]]): The received combinations (including the locally produced one).
        _one (Public[field]): The multiplicative identity.
