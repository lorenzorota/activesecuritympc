...
from ..decompositions.protocol_3p import protocol_0, protocol_1, protocol_2
...
def auth_protocol_0(
    ...
    randomness: Private[Array[field, 2]],
    blinding_factors: Private[Array[field, 6]],
    party_index: Public[int],
    _one: Public[field],
) -> Array[Array[int, 8], 3]:
    """Private protocol authentication for protocol 0"""
    outputs_comm: Array[Array[int, 8], 3] = [[0 for _ in range(8)] for _ in range(N)]
    outputs: Array[field, 3] = protocol_0(secret, randomness, party_index, _one)
...
def auth_protocol_1(
    private_input: Private[Array[field, 3]],
    blinding_factors: Private[Array[field, 6]],
    public_input_comm: Public[Array[Array[int, 8], 3]],
    _one: Public[field],
) -> field:
...
def auth_protocol_2(
    public_input: Public[Array[field, 3]],
    _one: Public[field],
) -> field:
